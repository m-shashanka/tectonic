...
export default function MobileSignup() {
  ...
  const checkUsername = async () => {
    if (usernameErrorMessage && usernameErrorMessage !== "Username Not Available")
      return;
    ...
    <div className={styles.container}>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className={errors.name ? styles.invalid : null}>
          ...
          <input type="text" placeholder="Name" name="name" {...register("name", { required: "name required" })}/>
        </div>
        ...
        <div className={errors.password ? styles.invalid : null}>
          ...
          />
          <FontAwesomeIcon icon={showPassword ? faEyeSlash : faEye} className={`${styles.item} ${styles.eye}`}
        ...
        {!formLoading && <button
            ...
            onClick={() => {!username && setUsernameErrorMessage("username required");}}
          >Sign Up</button>}
